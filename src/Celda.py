...
class Celda():
    def __init__(self, a,b,c,d, bool_42):
        self.walls = {
            Direccion.OESTE: a,
            Direccion.SUR: b,
            Direccion.ESTE: c,
    ...
    def bin_to_hexa(self) -> str:
        ...
        if valor == 101:  return '5'
        if valor == 110:  return '6'
        if valor == 111:  return '7'
        if valor == 1000: return '8'
        if valor == 1001: return '9'
        if valor == 1010: return 'A'
        if valor == 1011: return 'B'
        if valor == 1100: return 'C'
