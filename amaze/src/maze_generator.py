...
from Direcccion import Direccion, MOVES, OPUESTO
import random
...
class MazeGenerator:
    def __init__(self, cfg: MazeConfig) -> None:
        ...
        self.grid2 = [
            [Celda() for _ in range(cfg.width)]
        ...
        self.entry = (self.cfg.entry_x,self.cfg.entry_y)
        self.exit = (self.cfg.exit,self.cfg.exit_y)
        self.perfect = cfg.perfect
